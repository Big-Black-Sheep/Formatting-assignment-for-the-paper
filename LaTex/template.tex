...
\usepackage{url}
\usepackage{ccaption}
\usepackage{booktabs} % 做三线表的上下两条粗线用\setcounter{page}{1}
...
\entitle{Virtual Tube Visual Obstacle Avoidance for UAV Based on Deep Reinforcement Learning}

\enauthor{Jing Zhao$^{1}$
\qquad
Zinan Pei$^1$
\qquad
Bin Jiang$^2$
...
\enkeyword{Autonomous obstacle avoidance, deep reinforcement learning (DRL), virtual tube, unmanned aerial vehicle (UAV)}

\cnaddress{}

\enaddress{Jing Zhao, Zinan Pei, Bin Jiang,Ningyun Lu, Fei Zhao,Shufeng Chen.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\linewidth]{../image/Fig1.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\linewidth]{../image/Fig2.pdf}
  \caption{. Schematic diagram of unmanned aerial vehicle
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\linewidth]{../image/Fig3.pdf}
  caption{. RCPPO algorithm architecture diagram }
  \label{fig:fig3}
\end{figure}
...
\bibitem{3} Su Lian-Cheng, Zhu Feng. Design of a novel omnidirectional stereo vision system. {\sl  Acta Automatica Sinica}
